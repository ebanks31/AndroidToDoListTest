...
this.contextinfo = context;
	...
	{
	    FeedReaderDbHelper db = new FeedReaderDbHelper(this);
	 	ArrayList<String> listitemlist = db.getAllListStringItemsByTitle(MyListFragment.currentspinner);
	...
	*/
	...
	public void SortListByDateModified(MenuItem item)
		{
	    FeedReaderDbHelper db = new FeedReaderDbHelper(this);
	 	ArrayList<String> listitemlist = db.getAllListStringItemsByDateModified(MyListFragment.currentspinner);
		updateList(listitemlist);
		 /*
		final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ListOrganizerActivity.this,
    	android.R.layout.simple_list_item_1, listitemlist);
   	 ...
   	 final DetailFragment detailfragment = (DetailFragment)
    	        ...
    	        Boolean invalidcharactersfound = ListOrganizerActivity.checkInvalidCharacters(listinput);
    				...
    				else	
    				{
						...
						if(values!=null)
						{
    					db.addListitem(new ListItem(MyListFragment.currentspinner, listinput,date,values.size()+1));  
						}
						else
						{
    					...
    					ListOrganizerActivity.values=ConvertArrayListtoArray(values1);
...
public boolean onContextItemSelected(MenuItem item) {
	 ...
	 final ListFragment listfragment = (ListFragment)
		...
		lst.addAll(Arrays.asList(ListOrganizerActivity.values));
  ...
  //if(menuItemName.equals("Add") && parentId==R.id.detailFragment)
  {
        ...
        // Setting Dialog Message
        alertDialog.setMessage("Add to your list");
         final EditText input = new EditText(this);  
			LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
        LinearLayout.LayoutParams.MATCH_PARENT,
        LinearLayout.LayoutParams.MATCH_PARENT);
        ...
        String listinput = input.getText().toString();
		  ...
		  //Add to Spinner
				...
				FeedReaderDbHelper db = new FeedReaderDbHelper(ListOrganizerActivity.this);
				CheckBox currentcheckbox2 = CustomAdapter.currentcheckboxlist.get(index);
				Date date = ListOrganizerActivity.getCurrentDate();
				ArrayList<String> lst2 =db.getAllListStringItemsByTitle(MyListFragment.currentspinner);
				updateList(lst2);
				
				if(CustomAdapter.currentcheckboxlist!=null)
				{
	            CheckBox currentcheckbox1 = CustomAdapter.currentcheckboxlist.get(index);
	            
	            if(currentcheckbox1.isChecked())
	            {
				int position = lst2.size();
				db.addListitem(new ListItem(MyListFragment.currentspinner, listinput,date,index+1));  
	        	...
	        	for(String listitem:values)
	        	{
	        		listitemarraylist.add(new ListItem(listitem,0));
	        	}
	        	ListItem[] stockArr = new ListItem[listitemarraylist.size()];
	        	stockArr = listitemarraylist.toArray(stockArr);
	    	    CustomAdapter adapter1 = new CustomAdapter(ListOrganizerActivity.this, stockArr,detailfragment);
    ...
    //else if(menuItemName.equals("Edit") && parentId==R.id.detailFragment)
  {
        ...
        // Setting Dialog Title
        alertDialog.setTitle("List Item Title");
		  ...
		  //Add to Spinner
				//String key = ((TextView) info.targetView).getText().toString();
			       ...
			       FeedReaderDbHelper db = new FeedReaderDbHelper(ListOrganizerActivity.this);
					...
					db.updateListItem(new ListItem(MyListFragment.currentspinner, listinput,index+1),date);  
                        
					}
					
				ArrayList<String> lst = new ArrayList<String>();
				lst.addAll(Arrays.asList(ListOrganizerActivity.values));
				lst.add(index+1,listinput);
				lst.remove(index);
         ...
         alertDialog.setNegativeButton("Yes",
                 new DialogInterface.OnClickListener() {
                     public void onClick(DialogInterface dialog, int which) {
                        ...
                        List<ListItem> list = db.getAllListItems();
                		...
                		db.deleteListItem(new ListItem(MyListFragment.currentspinner, lst5.get(index),index+1)); 
                	  ...
                	  ListAdapter listadapter1= detailfragment.getListAdapter();
                		...
                		lst1.addAll(Arrays.asList(ListOrganizerActivity.values));
                	    final ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(ListOrganizerActivity.this,
                	  ...
                	  ListOrganizerActivity.values=deleteItemFromArray(lst1,currentitem1);}
...
public void detailFragmentSelected(String[] values, ArrayAdapter<String> adapter) {
	// TODO Auto-generated method stub
	ListOrganizerActivity.values=values;
...
public void updateList(ArrayList<String> values) {
    ...
    DetailFragment detailfragment = (DetailFragment) getFragmentManager()
        ...
        if (detailfragment != null && detailfragment.isInLayout()) {
    	    ...
    	    ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
    	        android.R.layout.simple_list_item_1, values);
    	     adapter1 = new CustomAdapter(this, stockArr,detailfragment);
    	    detailfragment.getListView().setAdapter(adapter1);
    	    adapter1.notifyDataSetChanged();
